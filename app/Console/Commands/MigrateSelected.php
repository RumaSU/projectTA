...
class MigrateSelected extends Command
{
    ...
    private $selected_migrate = [
        'db' . DIRECTORY_SEPARATOR . '0000_000_01_app_locations.php',
        'db' . DIRECTORY_SEPARATOR . '0000_000_session_table.php',
        'db' . DIRECTORY_SEPARATOR . '0001_000_user.php',
        'db' . DIRECTORY_SEPARATOR . '0003_000_document.php',
        'db' . DIRECTORY_SEPARATOR . '0003_001_document_signature.php',
        'db' . DIRECTORY_SEPARATOR . '0003_002_document_signed.php',
        'db' . DIRECTORY_SEPARATOR . '0004_000_signatures.php',
        'db' . DIRECTORY_SEPARATOR . '0050_000_token.php',
        'db' . DIRECTORY_SEPARATOR . '0080_000_file.php',
        'db' . DIRECTORY_SEPARATOR . '0080_001_file_entity.php',
        'db' . DIRECTORY_SEPARATOR . '0100_000_jobs_docs_table.php',
        'db' . DIRECTORY_SEPARATOR . '0200_000_certificate.php',
        'db' . DIRECTORY_SEPARATOR . '9999_001_references_table_session.php',
        'db' . DIRECTORY_SEPARATOR . '9999_002_references_table_users.php',
        'db' . DIRECTORY_SEPARATOR . '9999_003_references_table_documents.php',
        'db' . DIRECTORY_SEPARATOR . '9999_004_references_table_documents_signatures.php',
        'db' . DIRECTORY_SEPARATOR . '9999_005_references_table_signatures.php',
        'db' . DIRECTORY_SEPARATOR . '9999_006_references_table_files.php',
        'db' . DIRECTORY_SEPARATOR . '9999_007_references_certificate.php',
        'db' . DIRECTORY_SEPARATOR . '9999_008_references_table_documents_signed.php',
