...
class Show extends Component
{
    ...
    public bool $can_view_audit = false;
    ...
    public function streamMainInfo() {
        ...
        if (Auth::check()) {
            $user = Auth::user();
            if ($user->id_user === $document->owner_id) {
                $this->can_view_audit = true;
            }
            
            $documentCollab = ModelUtils::createInstanceModel(\App\Models\Documents\DocumentCollaborator::class)
    ...
    {
        return view('livewire.app.audit.verify.show');
    }
}
