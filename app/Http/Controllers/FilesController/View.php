...
class View extends Controller
{
    ...
    public function view($token) {
        ...
        return match($entity) {
            Entity::SIGNATURE => redirect()->route('drive.files.entity_signature', ['token' => $token]),
            Entity::DOCUMENT => redirect()->route('drive.files.entity_document', ['token' => $token])
        };
    }
    
    
    public function signatureView($token) {
    ...
    public function documentView($token) {
