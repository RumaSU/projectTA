...
class SignaturesDrawingServices {
    ...
    public static function handleSave(array $data_drawing) {
        $instance = new static;
        $instance->data_drawing = $data_drawing;
        
        return $instance->executeSaveDrawing();
    }
    
    public static function handleGetList(string $id_user) {
        $instance = new static;
    ...
    public static function handleGetDefault(string $id_user) {
        $instance = new static;
        $instance->id_user = $id_user;
    ...
    public function executeSaveDrawing() {
        $resultReturn = [
            'status' => false,
