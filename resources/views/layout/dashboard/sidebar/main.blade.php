...
<div class="mainNavAside">
    <div class="itmNvAside">
        <a href="{{ route('app.dashboard.home') }}"
            ...
            class="homeFieldDashboard block py-2 px-4 text-white rounded-lg overflow-hidden relative transition-all group {{ Route::is('app.dashboard.home') ? $routeActive : $routeNotActive }}"
            role="link"
            ...
            <div class="stickActive w-1.5 h-3/4 rounded-full bg-[#E6BF3C] absolute left-0 top-1/2 -translate-y-1/2 transition-all {{ Route::is('app.dashboard.home') ? $routeStickActive : $routeStickNotActive }}"></div>
        </a>
    </div>
</div>
        ...
        (object) array(
            ...
            'lstNavAside' => [
                ...
                (object) array(
                    ...
                    'routeNav' => route('app.documents.main'),
