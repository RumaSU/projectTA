    ...
    @push('dashboard-body-script')
        <script data-navigate-once>
            Alpine.data('typeNewSignature', () => {
                ...
                const templateFonts =  @json(\App\Enums\Signatures\Font::get_mapped_fonts());
                
                const variants = {
                    original: @json(\App\Enums\Signatures\Variant::ORIGINAL->value),
                    thumbnail: @json(\App\Enums\Signatures\Variant::THUMBNAIL->value)
                };
                const ruleType = @json($ruleFonts);
                const acceptType = @json(\App\Enums\Signatures\Type::get_map_value());
                ...
                return {
                    ...
                    selectStyle: templateFonts.find(x => x.default),
                    colors: templateColors,
                    styles: templateFonts,
                    ...
                    updateTypeStyle($e) {
                        ...
                        const accept = templateFonts.find(x => x.value == value);
                        if (! accept) return;
                    ...
                    resetType() {
                        ...
                        this.selectStyle = templateFonts.find(x => x.default);
