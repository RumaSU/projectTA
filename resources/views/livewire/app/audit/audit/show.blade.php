...
>
    ...
    <div class="main-info-audit">
        <div class="header-main-info-audit flex items-center justify-between border-b border-b-gray-400 pb-2">
            ...
            <div class="view-document">
                <a href="{{ route('app.signs.main', ['id_document' => $id_document]) }}" 
    ...
    <div class="audit-info-audit mt-6">
        <div class="header-info-audit border-b border-b-gray-400 flex items-center gap-2">
            <div class="title-info-audit">
                <div class="text-title text-2xl font-semibold">
                    <p>Audit Trail</p>
                </div>
        ...
        <div class="info-audit mt-4" wire:ignore wire:stream='infoAuditTrait'>
                ...
                Alpine.data('audit_document', () => {
                    ...
                    return {
                        init() {
                            ...
                            Livewire.dispatch('Stream-Audit-Trail');
                        }
                    };
