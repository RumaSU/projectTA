...
@section('default-layout-head-field')
    ...
    @stack('audit-head-css')
    
    @livewireStyles
@endsection

@push('default-aditional-prop-body')
    class="h-screen flex flex-col @stack('audit-attr-class-val-body')"
    @stack('audit-attr-body')
@endpush

@section('default-layout-body-content')
    
    <header class="py-2 px-4 bg-[#f1f1f1] z-50">
