...
>
    <div 
        ...
        class="{{ Str::contains(request()->route()->getName(), 'app') ? 'mt-20' : '' }} group pointer-events-none z-50 fixed inset-x-8 top-0 flex max-w-full flex-col gap-2 bg-transparent p-4 md:left-[unset] md:right-0 md:max-w-md"
